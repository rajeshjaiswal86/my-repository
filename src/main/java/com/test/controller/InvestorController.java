...
public class InvestorController {
	...
	public @ResponseBody ResponseEntity<?> createInvestor(@RequestBody InputVO inputVO) {
	...
	public @ResponseBody ResponseEntity<?> updateInvestor(@RequestBody InputVO inputVO) {
